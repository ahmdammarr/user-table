...
const styles = {
  container: "flex min-h-12 w-[500px] justify-between align-center items-center mt-3",
  inputContainer: "w-3/4 relative border-2 border-light-black rounded h-12 px-2",
  svgContainer: 'absolute top-2 right-2',
  input: "text-black h-full w-3/4",
  button: 'ml-3 text-white bg-blue hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm p-3 w-[170px]'
